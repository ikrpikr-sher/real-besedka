...
| 2026-09-04 | `site_health/onpage.py` | 2 категории; только «Категория: slug» | все 5 из sitemap + bare slug + leftover sovety | сирота 200 без noindex | P2 в backlog |
| 2026-09-04 | журнал + Canvas | сводка 03.09 | факты 04.09: sitemap без изменений; сирота sovety | weekday + сверка | честный отчёт |
